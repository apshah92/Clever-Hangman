...
def playGame(words):
    ...
    while True:
        ...
        if letter=='+':
            ...
            '''
                elif len(dictionary_of_templates[key]) == max_category_words:
            '''
...
# when values are the same, does the program choose the first key? or the key with the least letters available?
# can I guess the same letter twice?
